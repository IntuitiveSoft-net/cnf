...
Il est à noter que mêmle si vos communications sont cryptés (https), les requêtes DNS elles sont en clair. Votre serveur DNS 
peu connaitre tous les sites que vous consultez. Idem si les communications sont interceptées/écoutées. 